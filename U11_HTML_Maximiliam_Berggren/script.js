...
function addParagraph() {
	...
	// currentText = document.createTextNode("This is a paragraph.");
	 ...
	 */
	 op.appendChild(	 document.createElement("P").appendChild(document.createTextNode("This is a paragraph."));
);
	/*
